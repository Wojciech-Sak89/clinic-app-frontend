...
import com.kodilla.clinic.ui.admin.form.StaffEvaluationForm;
...
public class StaffEvaluationsView extends VerticalLayout {
    ...
    public StaffEvaluationsView(ClinicService clinicService) {
        ...
        staffEvaluationGrid.setColumns("patient_Id", "doctor_Id", "stars", "opinion");
        setColumnNames(staffEvaluationGrid);
        staffEvaluationGrid.addColumn(new LocalDateTimeRenderer<>(
